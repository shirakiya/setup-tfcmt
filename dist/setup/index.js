...
var require_file_command = __commonJS({
  "node_modules/@actions/tool-cache/node_modules/@actions/core/lib/file-command.js"(exports2) {
    ...
    function issueFileCommand2(command, message) {
      ...
      fs3.appendFileSync(filePath, `${(0, utils_1.toCommandValue)(message)}${os6.EOL}`, {
        encoding: "utf8"
      });
    }
...
// node_modules/@actions/tool-cache/node_modules/@actions/core/lib/oidc-utils.js
var require_oidc_utils = __commonJS({
  "node_modules/@actions/tool-cache/node_modules/@actions/core/lib/oidc-utils.js"(exports2) {
    "use strict";
    var __awaiter2 = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
var require_summary = __commonJS({
  "node_modules/@actions/tool-cache/node_modules/@actions/core/lib/summary.js"(exports2) {
    "use strict";
    var __awaiter2 = exports2 && exports2.__awaiter || function(thisArg, _arguments, P, generator) {
      function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
// node_modules/@actions/tool-cache/node_modules/@actions/core/lib/path-utils.js
var require_path_utils = __commonJS({
  "node_modules/@actions/tool-cache/node_modules/@actions/core/lib/path-utils.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
...
var require_platform = __commonJS({
  "node_modules/@actions/tool-cache/node_modules/@actions/core/lib/platform.js"(exports2) {
    "use strict";
    var __createBinding = exports2 && exports2.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
  ...
  "node_modules/@actions/tool-cache/lib/tool-cache.js"(exports2) {
    ...
    function cacheDir2(sourceDir, tool, version, arch2) {
      return __awaiter2(this, void 0, void 0, function* () {
        ...
        core.debug(`Caching tool ${tool} ${version} ${arch2}`);
    ...
    function getManifestFromRepo(owner_1, repo_1, auth_1) {
      return __awaiter2(this, arguments, void 0, function* (owner, repo, auth, branch = "master") {
        let releases = [];
    ...
    function findFromManifest(versionSpec_1, stable_1, manifest_1) {
      return __awaiter2(this, arguments, void 0, function* (versionSpec, stable, manifest, archFilter = os6.arch()) {
    ...
    function _createExtractFolder(dest) {
      return __awaiter2(this, void 0, void 0, function* () {
        if (!dest) {
          dest = path3.join(_getTempDirectory(), crypto2.randomUUID());
        }
...
// src/setup.ts
var CMD_NAME = "tfcmt";
var mapPlatform = (platform2) => {
  const mappings = {
    darwin: "darwin",
    linux: "linux",
    win32: "windows"
  };
  if (!(platform2 in mappings)) {
    throw new Error(`OS platform ${platform2} is not available for tfcmt`);
  }
  return mappings[platform2];
};
var mapArch = (arch2) => {
  const mappings = {
    x64: "amd64",
  ...
  if (!(arch2 in mappings)) {
    throw new Error(`OS architecture ${arch2} is not available for tfcmt`);
  }
  return mappings[arch2];
};
var specifyReleaseVersion = (version) => {
  const availableReleaseVersions = versions_default;
  debug(
...
var getBuildURL = (version, platform2, arch2) => {
  return `https://github.com/suzuki-shunsuke/tfcmt/releases/download/${version}/tfcmt_${platform2}_${arch2}.tar.gz`;
};
var download = async (inputVersion, osPlatform, osArch) => {
  const version = specifyReleaseVersion(inputVersion);
  debug(
    `the input version [${inputVersion}] identifies the release version as ${version}`
  );
  const platform2 = mapPlatform(osPlatform);
  const arch2 = mapArch(osArch);
  debug(`getting build for tfcmt version ${version}: ${platform2} ${arch2}`);
  const buildURL = getBuildURL(version, platform2, arch2);
  info(`downloading tfcmt from ${buildURL}`);
  const pathToArchive = await tc.downloadTool(buildURL);
  debug(`extracting tfcmt build archive file from ${pathToArchive}`);
  const pathToExtractedDir = await tc.extractTar(pathToArchive);
  debug(`the build archive of tfcmt is extracted to ${pathToExtractedDir}`);
  ...
  debug(`cached tfcmt path is ${cachedPath}`);
  return {
    path: cachedPath,
    url: buildURL
  };
...
var run = async () => {
  ...
  addPath(result.path);
  exportVariable("TFCMT_DIR_PATH", result.path);
  exportVariable("TFCMT_CMD_PATH", path2.join(result.path, CMD_NAME));
  return result;
};
var main = async () => {
  try {
    ...
    if (e instanceof Error) {
      ...
      setFailed("Error. Please check the action logs.");
    }
  }
};
void main();
